/**
 * Created by geoffbrown1 on 11/2/15.
 */
...
function Fish() {
    ...
    this.updateIdleFish = function () {
        this.y = height - 260 + 120 * Math.cos(frames / 20);
        //this.x = height - 260 + 120 * Math.cos(frames / 18);
        this.rotation = 180;
    };
...
function windowSetup() {
    ...
    document.addEventListener(inputEvent2, onpress);
}
...
function splash() {
    renderingContext.font="20px Arial bolder";
    renderingContext.fillStyle="black";
    renderingContext.fillRect(25,356,10,10);
    renderingContext.fillRect(25,393,10,10);
    renderingContext.fillText("HIT SPACE OR CLICK TO SWIM.",40,368);
    renderingContext.fillText("DON'T TOUCH ANYTHING!",40,405);
    renderingContext.fillStyle="#65D0D6";
    textSprites.getReady.draw(renderingContext,200,150);
    okButtonSprite.draw(renderingContext,250, 197);

}

function gameOver() {
    textSprites.gameOver.draw(renderingContext,100,50);
    okButtonSprite.draw(renderingContext,  ((width - okButtonSprite.width) / 2), (height - 214));
    renderingContext.font="25px Arial bolder";
    renderingContext.fillStyle="white";
    renderingContext.fillText("CLICK OK TO TRY AGAIN",40,168);
    renderingContext.fillStyle="#65D0D6";
}
